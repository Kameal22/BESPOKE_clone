...
const InteriorStyleChoice: React.FC = () => {
    ...
    const images = [{ img: loft, name: "loft" }, { img: minimalistyczny, name: "minimalistyczny" }, { img: nowoczesny, name: "nowoczesny" }, { img: skandynawski, name: "skandynawski" }]
        ...
        <div className="interiorStyleChoiceDiv">
            ...
            <div className="interiorChoiceImages">
                ...
                <div className="interiorChoice">
                    {images.map((img) => {
                        return (
                            <div onClick={() => setShownImage(img.img)} className="imgDiv">
                                <img src={img.img} />
